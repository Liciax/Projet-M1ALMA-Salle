...
public class BaseDeDonnee {
  ...
  // .getIdSalle())
  // && (value.getHeureDebutReserve().compareTo(entries.get(i).getValue().getHeureFinReserve()) >=
  // 0)) {
  //
  ...
  // || (value.getHeureFinReserve().compareTo(entries.get(i).getValue().getHeureDebutReserve()) >=
  // 0)) {
