...
public class Reservation {
	...
	private ArrayList<Materiel> materiauxMobiles;
	
	public Reservation(Salle salleReservee, Calendar dateDebutReserve, Calendar dateFinReserve, int idClient, DureeReservation dureeReservation) {
		this.salleReservee = salleReservee;
		this.dateDebutReserve = dateDebutReserve;
		this.dateFinReserve = dateFinReserve;
		this.idClient = idClient;
		this.idReserve = Integer.toString(dateDebutReserve.get(Calendar.DAY_OF_YEAR))+Integer.toString(dateDebutReserve.get(Calendar.YEAR)) + Integer.toString(idClient);
