...
public class GestionSalleImpl implements GestionSalle {
  ...
  //                     pour les adresses                              //
  //--------------------------------------------------------------------//                 
  public boolean creationAdresse(int noRue, String rue, int codePostal, String ville, String complement) {
  ...
  public boolean ajouterSallesABatiment(String idBat, String idSalle) {
    BatimentImpl bat = (BatimentImpl) bdd.get(idBat);
  ...
  public boolean retirerSalleABatiment(String idBat, String idSalle) {
    BatimentImpl bat = (BatimentImpl) bdd.get(idBat);
    SalleImpl salle = (SalleImpl) bdd.get(idSalle);
    salle.setIdBat("");
  ...
  public boolean creationSalle(int noEtage, int noSalle, int superficie,
      String typeSalle) {
